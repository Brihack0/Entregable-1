//Menu pa las barras y pa la animacion de mis las habilidades
...
let php = document.getElementById("Pyton");
crearBarra(Pyton);
...
function efectoHabilidades(){
    ...
    if(distancia_skills>=300 && entro==false){
        ...
        const intervalPyton = setInterval(function(){
            pintarBarra(php, 15, 4, intervalPyton);
        },100);
...
function pintarBarra(id_barra, cantidad, indice, interval){
    ...
    if(x < cantidad){
        ...
        elementos[x].style.backgroundColor = "#0E8388";
    }else{
